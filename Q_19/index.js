...
let invited_person = ["Usama_Billadin", "Obama", "Quaide_E_Azam",];
let message = "I am inviting u at dinner";
function foorloop() {
...
let absent_person = "Usama_Billadin";
let new_guest = "Gandi_Ji";
console.log(`\nNote:
...
while (invited_person.length > 2) {
    ...
    console.log(`Sorry dear. ${Remove_guest1}. You are not invited to dinner `);
}
...
console.log(invited_person);
console.log(`currently we are inviing ${invited_person.length} peoples `);
